        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="flex flex-col gap-7">
            ...
            >
              ...
              {/* Accent glow */}
              <div
                className="absolute -top-16 left-1/2 -translate-x-1/2 h-64 w-64 rounded-full blur-3xl opacity-20"
